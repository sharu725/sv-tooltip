...
<div class="content">
  ...
  <fieldset>
    ...
    <div class="code">
      {@html Prism.highlight(
        `<p>Something <Tooltip tip="It was actially a dream" top>wierd</Tooltip> happened last night</p>`,
  ...
  <nav>
    <ul>
      <li>
        <a href="https://github.com/sharu725/sv-tooltip">github</a>
      </li>
      <li>
        <a href="https://webjeda.com">webjeda</a>
      </li>
    </ul>
  </nav>
</div>
